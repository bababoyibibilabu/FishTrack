...
describe('Coordinate Conversion Test', () => {
  it('should convert WGS-84 to GCJ-02 correctly', () => {
    ...
    expect(result.lng).toBeCloseTo(116.403672, 6)
    expect(result.lat).toBeCloseTo(39.910160, 6)
  })
  ...
  it('should convert GCJ-02 to BD-09 correctly', () => {
    ...
    expect(result.lng).toBeCloseTo(116.410350, 6)
    expect(result.lat).toBeCloseTo(39.916416, 6)
  })
})
